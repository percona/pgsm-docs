...
The following table describes the `pg_stat_monitor` view for PostgreSQL 18 and higher versions.

???+ admonition "PostgreSQL 18"
     ...
     | wal_buffers_full    | bigint                | Number of times the WAL buffers became full
